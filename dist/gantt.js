export class GanttChart {
    constructor(containerId, tasks, config) {
        ...
        this.margin = { top: 60, right: 20, bottom: 20, left: 150 };
        ...
        this.tasks = tasks;
        this.config = Object.assign({ timelineMonths: 12 }, config); // Default to 12 months
        this.render();
    }
    render() {
        // Create tooltip
        ...
        maxDate.setFullYear(maxDate.getFullYear(), maxDate.getMonth() + (this.config.timelineMonths || 12)); // Extend timeline
        ...
        priorities.forEach((priority, pIndex) => {
            ...
            if (pIndex < priorities.length - 1) {
                ...
                separator.setAttribute("x2", (this.scrollableWidth - this.margin.right).toString());
